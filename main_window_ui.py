...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(620, 690, 341, 71))
        self.label.setMinimumSize(QtCore.QSize(241, 71))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold SemiConden")
        font.setPointSize(16)
        font.setBold(True)
...
""))
        ...
        self.label.setText(_translate("MainWindow", "Developer： Ching I Lee"))
